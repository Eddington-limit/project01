...
router.post("/comment",auth.ensureLoggedIn, (req, res) => {
  const newComment = new Comment({
    creator_id: req.user._id,
    creator_name: req.user.name,
    parent: req.body.parent, // links to the _id of a parent story (_id is an autogenerated field by Mongoose).
    content: req.body.content
  });
...
router.post("/message", auth.ensureLoggedIn, (req, res) => {
  ...
  socketManager.getSocketFromUserID(req.user._id).emit("message", newMessage);
    if (req.user._id !== req.body.recipient._id &&socketManager.getSocketFromUserID(req.body.recipient._id)) {
      socketManager.getSocketFromUserID(req.body.recipient._id).emit("message", newMessage);
    }
  }
);
